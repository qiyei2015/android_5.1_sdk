 ...
 * Original file: /work/android_5.1_sdk/packages/apps/Email/emailcommon/src/com/android/emailcommon/service/IPolicyService.aidl
 */
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_canDisableCamera, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
