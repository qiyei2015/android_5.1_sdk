 ...
 * Original file: /work/android_5.1_sdk/frameworks/base/core/java/com/android/internal/view/IInputMethodManager.aidl
 */
...
@Override public void commitText(java.lang.String text) throws android.os.RemoteException
{
...
static final int TRANSACTION_commitText = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
...
static final int TRANSACTION_getShortcutInputMethodsAndSubtypes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_addClient = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_removeClient = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_startInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_finishInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_showSoftInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_hideSoftInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_windowGainedFocus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_showInputMethodPickerFromClient = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_showInputMethodAndSubtypeEnablerFromClient = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_setInputMethod = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_setInputMethodAndSubtype = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_hideMySoftInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_showMySoftInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_updateStatusIcon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_setImeWindowStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_registerSuggestionSpansForNotification = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_notifySuggestionPicked = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getCurrentInputMethodSubtype = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_setCurrentInputMethodSubtype = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_switchToLastInputMethod = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_switchToNextInputMethod = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_shouldOfferSwitchingToNextInputMethod = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_setInputMethodEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_setAdditionalInputMethodSubtypes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getInputMethodWindowVisibleHeight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_notifyUserAction = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
}
//$_rbox_$_modify_$_chenxiao_begin,add for remotecontrol

public void commitText(java.lang.String text) throws android.os.RemoteException;
//$_rbox_$_modify_$_end
// TODO: Use ParceledListSlice instead
