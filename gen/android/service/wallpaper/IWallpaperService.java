 ...
 * Original file: /work/android_5.1_sdk/frameworks/base/core/java/android/service/wallpaper/IWallpaperService.aidl
 */
...
@Override public void attach(android.service.wallpaper.IWallpaperConnection connection, android.os.IBinder windowToken, int windowType, boolean isPreview, int reqWidth, int reqHeight, android.graphics.Rect padding) throws android.os.RemoteException
{
...
public void attach(android.service.wallpaper.IWallpaperConnection connection, android.os.IBinder windowToken, int windowType, boolean isPreview, int reqWidth, int reqHeight, android.graphics.Rect padding) throws android.os.RemoteException;
}
