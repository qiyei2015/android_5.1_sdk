 ...
 * Original file: /work/android_5.1_sdk/frameworks/base/core/java/android/service/carrier/ICarrierMessagingService.aidl
 */
...
this.sendTextSms(_arg0, _arg1, _arg2, _arg3);
return true;
}
...
android.service.carrier.ICarrierMessagingCallback _arg4;
_arg4 = android.service.carrier.ICarrierMessagingCallback.Stub.asInterface(data.readStrongBinder());
this.sendDataSms(_arg0, _arg1, _arg2, _arg3, _arg4);
return true;
}
...
android.service.carrier.ICarrierMessagingCallback _arg3;
_arg3 = android.service.carrier.ICarrierMessagingCallback.Stub.asInterface(data.readStrongBinder());
this.sendMultipartTextSms(_arg0, _arg1, _arg2, _arg3);
return true;
}
...
/**
     ...
     * @param callback the callback to notify upon completion
     */
@Override public void sendTextSms(java.lang.String text, int subId, java.lang.String destAddress, android.service.carrier.ICarrierMessagingCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
/**
     ...
     * @param callback the callback to notify upon completion
     */
@Override public void sendDataSms(byte[] data, int subId, java.lang.String destAddress, int destPort, android.service.carrier.ICarrierMessagingCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
/**
     ...
     * @param callback the callback to notify upon completion
     */
@Override public void sendMultipartTextSms(java.util.List<java.lang.String> parts, int subId, java.lang.String destAddress, android.service.carrier.ICarrierMessagingCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
...
/**
     ...
     * @param callback the callback to notify upon completion
     */
public void sendTextSms(java.lang.String text, int subId, java.lang.String destAddress, android.service.carrier.ICarrierMessagingCallback callback) throws android.os.RemoteException;
/**
     * Request sending a new data SMS from the device.
     * The service will call {@link ICarrierMessagingCallback#onSendSmsComplete} with the send
     * status.
     ...
     * @param callback the callback to notify upon completion
     */
public void sendDataSms(byte[] data, int subId, java.lang.String destAddress, int destPort, android.service.carrier.ICarrierMessagingCallback callback) throws android.os.RemoteException;
/**
     * Request sending a new multi-part text SMS from the device.
     * The service will call {@link ICarrierMessagingCallback#onSendMultipartSmsComplete}
     * with the send status.
     ...
     * @param callback the callback to notify upon completion
     */
public void sendMultipartTextSms(java.util.List<java.lang.String> parts, int subId, java.lang.String destAddress, android.service.carrier.ICarrierMessagingCallback callback) throws android.os.RemoteException;
/**
     * Request sending a new MMS PDU from the device.
     * The service will call {@link ICarrierMessagingCallback#onSendMmsComplete} with the send
     * status.
