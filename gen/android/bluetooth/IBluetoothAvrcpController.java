 ...
 * Original file: /work/android_5.1_sdk/frameworks/base/core/java/android/bluetooth/IBluetoothAvrcpController.aidl
 */
...
/**
 * Cast an IBinder object into an android.bluetooth.IBluetoothAvrcpController interface,
 * generating a proxy if needed.
 */
public static android.bluetooth.IBluetoothAvrcpController asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
...
case TRANSACTION_sendPassThroughCmd:
{
data.enforceInterface(DESCRIPTOR);
android.bluetooth.BluetoothDevice _arg0;
if ((0!=data.readInt())) {
...
int _arg2;
_arg2 = data.readInt();
this.sendPassThroughCmd(_arg0, _arg1, _arg2);
reply.writeNoException();
return true;
}
}
...
@Override public void sendPassThroughCmd(android.bluetooth.BluetoothDevice device, int keyCode, int keyState) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_getDevicesMatchingConnectionStates = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
static final int TRANSACTION_getConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_sendPassThroughCmd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
}
...
public void sendPassThroughCmd(android.bluetooth.BluetoothDevice device, int keyCode, int keyState) throws android.os.RemoteException;
}
