 ...
 * Original file: /work/android_5.1_sdk/frameworks/base/core/java/android/bluetooth/IBluetoothPan.aidl
 */
...
/**
 * Cast an IBinder object into an android.bluetooth.IBluetoothPan interface,
 * generating a proxy if needed.
 */
public static android.bluetooth.IBluetoothPan asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof android.bluetooth.IBluetoothPan))) {
return ((android.bluetooth.IBluetoothPan)iin);
}
return new android.bluetooth.IBluetoothPan.Stub.Proxy(obj);
}
...
static final int TRANSACTION_isTetheringOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
static final int TRANSACTION_setBluetoothTethering = (android.os.IBinder.FIRST_CALL_TRANSACTION + 1);
