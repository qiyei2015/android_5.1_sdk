 ...
 * Original file: /work/android_5.1_sdk/frameworks/base/core/java/android/view/accessibility/IAccessibilityInteractionCallback.aidl
 */
 ...
 * @hide
 */
public interface IAccessibilityInteractionCallback extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements android.view.accessibility.IAccessibilityInteractionCallback
{
private static final java.lang.String DESCRIPTOR = "android.view.accessibility.IAccessibilityInteractionCallback";
...
/**
 * Cast an IBinder object into an android.view.accessibility.IAccessibilityInteractionCallback interface,
 * generating a proxy if needed.
 */
public static android.view.accessibility.IAccessibilityInteractionCallback asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof android.view.accessibility.IAccessibilityInteractionCallback))) {
return ((android.view.accessibility.IAccessibilityInteractionCallback)iin);
}
return new android.view.accessibility.IAccessibilityInteractionCallback.Stub.Proxy(obj);
}
...
private static class Proxy implements android.view.accessibility.IAccessibilityInteractionCallback
{
