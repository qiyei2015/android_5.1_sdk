 ...
 * Original file: /work/android_5.1_sdk/frameworks/base/core/java/android/content/IClipboard.aidl
 */
...
@Override public void setPrimaryClip(android.content.ClipData clip, java.lang.String callingPackage) throws android.os.RemoteException
{
...
@Override public android.content.ClipData getPrimaryClip(java.lang.String pkg) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public android.content.ClipDescription getPrimaryClipDescription(java.lang.String callingPackage) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
@Override public boolean hasPrimaryClip(java.lang.String callingPackage) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
@Override public void addPrimaryClipChangedListener(android.content.IOnPrimaryClipChangedListener listener, java.lang.String callingPackage) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void removePrimaryClipChangedListener(android.content.IOnPrimaryClipChangedListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
     ...
     */
@Override public boolean hasClipboardText(java.lang.String callingPackage) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
public android.content.ClipDescription getPrimaryClipDescription(java.lang.String callingPackage) throws android.os.RemoteException;
public boolean hasPrimaryClip(java.lang.String callingPackage) throws android.os.RemoteException;
public void addPrimaryClipChangedListener(android.content.IOnPrimaryClipChangedListener listener, java.lang.String callingPackage) throws android.os.RemoteException;
...
/**
     * Returns true if the clipboard contains text; false otherwise.
     */
public boolean hasClipboardText(java.lang.String callingPackage) throws android.os.RemoteException;
}
